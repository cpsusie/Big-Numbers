...
void QEF::evaluate(double mat[][3], double *vec, int rows, D3DXVECTOR3 *point) {
  ...
  *point = D3DXVECTOR3((float)x[0], (float)x[1], (float)x[2]);
}

void QEF::computeSVD(double mat[][3]                 // matrix (rows x 3)
...
void QEF::factorize(double mat[][3]                 // matrix (rows x 3)
...
void QEF::unpack(double u[][3]                   // matrix (rows x 3)
                ,double v[3][3]                  // matrix (3x3)
                ,double tau_u[3]                 // vector, (1x3)
                ,double tau_v[2]                 // vector, (1x2)
                ,int    rows) {
...
void QEF::diagonalize(double u[][3]                   // matrix (rows x 3)
                     ,double v[3][3]                  // matrix (3x3)
                     ,double tau_u[3]                 // vector, (1x3)
                     ,double tau_v[2]                 // vector, (1x2)
                     ,int    rows)
...
void QEF::qrstep(double u[][3]                   // matrix (rows x cols)
...
void QEF::qrstep_middle(double u[][3]                   // matrix (rows x cols)
                       ,double tau_u[]                  // vector (1 x cols)
                       ,double tau_v[]                  // vector (1 x cols - 1)
                       ,int    rows
                       ,int    cols
...
void QEF::qrstep_end(double v[][3]                   // matrix (3 x 3)
...
double QEF::qrstep_eigenvalue(double tau_u[]                  // vector (1 x 3)
                             ,double tau_v[]                  // vector (1 x 2)
                             ,int    cols) {
...
void QEF::qrstep_cols2(double u[][3]                   // matrix (rows x 2)
...
void QEF::singularize(double u[][3]                   // matrix (rows x 3)
                     ,double v[3][3]                  // matrix (3x3)
                     ,double d[3]                     // vector, (1x3)
                     ,int    rows) {
  int i, j, y;
...
void QEF::solveSVD(double u[][3]                   // matrix (rows x 3)
                  ,double v[3][3]                  // matrix (3x3)
                  ,double d[3]                     // vector (1x3)
