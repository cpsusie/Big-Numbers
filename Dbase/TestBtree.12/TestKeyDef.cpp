...
static void testKeyDefAddKeyField() {
  _tprintf(_T("testKeyDefAddKeyField\n"));
...
static void testKeyDefSigned() {
  _tprintf(_T("testKeyDefsigned\n"));
...
static void testKeyDefUnsigned() {
  _tprintf(_T("testKeyDefUnsigned\n"));
...
static void testKeyDefSignedNull() {
  _tprintf(_T("testKeyDefSignedNull\n"));
...
static void testKeyDefUnsignedNull() {
  _tprintf(_T("testKeyDefUnsignedNull\n"));
...
static void testKeyDefCompare() {
  _tprintf(_T("testKeyDefCompare\n"));
...
void testKeyDef() {
  _tprintf(_T("testKeyDef\n"));

  testKeyDefAddKeyField();
  testKeyDefSigned();
  testKeyDefUnsigned();
  testKeyDefSignedNull();
  testKeyDefUnsignedNull();
  testKeyDefCompare();
}
