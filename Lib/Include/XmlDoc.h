...
public:
  ...
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, String          &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, int             &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, unsigned int    &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, float           &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, double          &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, Date            &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, Timestamp       &value, int  instans=0);
  void getValue(const TCHAR *nodeName, const TCHAR *tagName, bool            &value, int  instans=0);
  ...
  void getValue(const XMLNodePtr &node    , const TCHAR *tagName, unsigned int    &value, int  instans=0);
  ...
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, const String    &value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, const TCHAR *value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, int              value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, unsigned int     value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, float            value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, double           value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, const Date      &value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, const Timestamp &value, bool force=true);
  void setValue(const TCHAR *nodeName, const TCHAR *tagName, bool             value, bool force=true);
  ...
  void setValue(const XMLNodePtr &node    , const TCHAR *tagName, unsigned int     value, bool force=true);
