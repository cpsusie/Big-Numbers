...
#ifndef _M_X64
#error Int128 is available only in x64 arhitecture
...
extern "C" void int128sum( void *dst, const void *x, const void *y);
extern "C" void int128dif( void *dst, const void *x, const void *y);
extern "C" void int128mul( void *dst, const void *x, const void *y);
extern "C" void int128div( void *dst, const void *x, const void *y);
extern "C" void int128rem( void *dst, const void *x, const void *y);
extern "C" void int128neg( void *dst, const void *x);
extern "C" int  int128cmp(const void *n1, const void *n2);
extern "C" void uint128div( void *dst, const void *x, const void *y);
extern "C" void uint128rem( void *dst, const void *x, const void *y);
extern "C" int  uint128cmp(const void *n1, const void *n2);
...
public:
  ...
  inline _int128(__int64 n) : lo(n), hi(0) {
  }
  inline _int128(unsigned int n) : lo(n), hi(0) {
  }
  inline _int128(int n) : lo(n), hi(0) {
  }
  inline _int128(unsigned short n) : lo(n), hi(0) {
  }
  inline _int128(short n) : lo(n), hi(0) {
  }
  _int128(const char *str);
...
public:
  ...
  inline _uint128(__int64 n) : lo(n), hi(0) {
  }
  inline _uint128(unsigned int n) : lo(n), hi(0) {
  }
  inline _uint128(int n) : lo(n), hi(0) {
  }
  inline _uint128(unsigned short n) : lo(n), hi(0) {
  }
  inline _uint128(short n) : lo(n), hi(0) {
  }
  _uint128(const char *str);
...
static inline char radixLetter(unsigned int c) {
  return (c < 10) ? ('0' + c) : ('a' + c);
}

static inline wchar_t wradixLetter(unsigned int c) {
  return (c < 10) ? ('0' + c) : ('a' + c);
}

static inline bool isodigit(unsigned char ch) {
  return ('0' <= ch) && (ch < '8');
}
