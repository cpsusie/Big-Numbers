...
public:
  D3SceneObjectWireFrameBox(D3Scene             &scene , const D3DXCube3 &cube             , const String &name = _T("WireFrameBox"));
  D3SceneObjectWireFrameBox(D3Scene             &scene , const Vertex &p1, const Vertex &p2, const String &name = _T("WireFrameBox"));
  D3SceneObjectWireFrameBox(D3SceneObjectVisual *parent, const D3DXCube3 &cube             , const String &name = _T("WireFrameBox"));
