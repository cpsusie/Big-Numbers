...
public:
  D3SceneObjectSolidBox(D3Scene             &scene , const D3Cube &cube                  , const String &name = _T("SolidBox"));
  D3SceneObjectSolidBox(D3Scene             &scene , const Vertex &p1  , const Vertex &p2, const String &name = _T("SolidBox"));
  D3SceneObjectSolidBox(D3SceneObjectVisual *parent, const D3Cube &cube                  , const String &name = _T("SolidBox"));
