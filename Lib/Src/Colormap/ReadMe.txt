========================================================================
    ACTIVEX CONTROL DLL : Colormap Project Overview
========================================================================

ControlWizard has created this project for your Colormap ActiveX Control
...
that make up your Colormap ActiveX Control DLL.
...
Colormap.ico
    ...
    is included by the main resource file Colormap.rc.

/////////////////////////////////////////////////////////////////////////////
CColormapCtrl control:

ColormapCtrl.h
    This file contains the declaration of the CColormapCtrl C++ class.

ColormapCtrl.cpp
    This file contains the implementation of the CColormapCtrl C++ class.

ColormapPropPage.h
    This file contains the declaration of the CColormapPropPage C++ class.

ColormapPropPage.cpp
    This file contains the implementation of the CColormapPropPage C++ class.

CColormapCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CColormapCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file Colormap.rc.
...
stdafx.h, stdafx.cpp
    ...
    named Colormap.pch and a precompiled types (PCT) file named stdafx.obj.
