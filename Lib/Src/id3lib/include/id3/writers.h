...
class ID3_CPP_EXPORT ID3_OStreamWriter : public ID3_Writer
{
 ...
 public:
  ID3_OStreamWriter(ostream& writer) : _stream(writer), _beg((pos_type)_stream.tellp()) { ; }
  ...
  virtual pos_type getCur() { return (pos_type)_stream.tellp(); }
};
...
class ID3_CPP_EXPORT ID3_IOStreamWriter : public ID3_Writer
{
 ...
 public:
  ID3_IOStreamWriter(iostream& writer) : _stream(writer), _beg((pos_type)_stream.tellp()) { ; }
