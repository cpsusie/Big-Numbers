...
# ADD LINK32 /nologo /subsystem:windows /dll /incremental:yes /machine:I386 /out:"c:\mytools\lib\MTRelease\id3lib.lib"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I ".\\" /I "..\\" /I "..\include" /I "..\include\id3" /I "..\zlib\include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "__DLL" /D "HAVE_CONFIG_H" /D ID3LIB_LINKOPTION=1 /FR /YX /FD /c
...
# ADD LINK32 ..\zlib\zlibD.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"c:\mytools\lib\MTDebug\id3lib.lib" /pdbtype:sept
# SUBTRACT LINK32 /pdb:none
