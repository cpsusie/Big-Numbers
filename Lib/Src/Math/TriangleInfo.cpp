...
// Return String with list of command line switches
...
String getTriangleInfo() {
  ...
  msg += "Triangle generates exact Delaunay triangulations, constrained Delaunay\n"
         ...
         "        useful; it gives information on algorithmic progress and much more\n"
         ...
         "  counterparts.\n\n"
         "  Many CPUs, including Intel x86 processors, have extended precision\n"
