...
****************************************************************************/
static void svdDecompose(Matrix &a, ComplexVector &d, Matrix &v) {
...
********************************************************************/
static ComplexVector svdSolve(const ComplexMatrix &u, const ComplexVector &d, const ComplexMatrix &v, const ComplexVector &b) {
...
ComplexSVDDecomposition::ComplexSVDDecomposition(const ComplexMatrix &a) : u(a) {
...
ComplexVector ComplexSVDDecomposition::solve(const ComplexVector &b) {
  int dim = b.getDimension();
  if(dim != u.getRowCount())
    throwException("Invalid dimension in SVDDecomposition::solve. dim(u)=(%d,%d). dim(b)=%d", u.getRowCount(),u.getColumnCount(),dim);
  return svdSolve(u,d,v,b);
}
