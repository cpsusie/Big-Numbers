...
#ifdef IS32BIT
#define _BITSCAN_FLAGS (ALL_GPR_BUTBYTE_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED)
#else // IS64BIT
#define _BITSCAN_FLAGS (ALL_GPR_BUTBYTE_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED | QWORDPTR_ALLOWED)
#endif // IS64BIT
