...
#ifdef IS32BIT
#define _BITSCAN_FLAGS (REGTYPE_GPR_ALLOWED | REGSIZE_WORD_ALLOWED | REGSIZE_DWORD_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED)
#else // IS64BIT
#define _BITSCAN_FLAGS (REGTYPE_GPR_ALLOWED | REGSIZE_WORD_ALLOWED | REGSIZE_DWORD_ALLOWED | REGSIZE_QWORD_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED | QWORDPTR_ALLOWED)
#endif // IS64BIT
