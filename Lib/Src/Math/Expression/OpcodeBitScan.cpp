...
#ifdef IS32BIT
#define _BITSCAN_FLAGS (NONBYTE_GPR_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED | HAS_NONBYTE_SIZEBITS)
#else // IS64BIT
#define _BITSCAN_FLAGS (NONBYTE_GPR_ALLOWED | WORDPTR_ALLOWED | DWORDPTR_ALLOWED | QWORDPTR_ALLOWED | HAS_NONBYTE_SIZEBITS)
#endif // IS64BIT
