...
const ExpressionDescription ExpressionDescription::expressionHelpList[] = {
   ...
   ,DESCRIPTION("acos(x)"                                      ,"The inverse cosine function over the domain -1 <= x <= 1.")
   ...
   ,DESCRIPTION("asin(x)"                                      ,"The inverse sine function over the domain -1 <= x <= 1.")
   ...
   ,DESCRIPTION("atanh(x)"                                     ,"The inverse hyperbolic tangent function over the domain -1 <= x <= 1.")
   ...
   ,DESCRIPTION("probit(x)"                                    ,"The inverse normal distribution function over the domain 0 < x < 1. probit(norm(x)) = x.")
   ,DESCRIPTION("product(i = startExpr to endExpr) expression" ,"ex. 10! = product(i=1 to 10) i.")
   ...
   ,DESCRIPTION("sum(i = startExpr to endExpr) expression"     ,"Ex: sum(i=0 to n) x^i/fac(i) -> exp(x) for n -> infinity.")
