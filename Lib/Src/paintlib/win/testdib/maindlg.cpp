...
/--------------------------------------------------------------------
|
|      $Id: maindlg.cpp,v 1.13 2004/09/11 12:41:38 uzadow Exp $
|
...
BOOL CDibtestDlg::OnInitDialog()
{
  ...
  m_pBigBmp->Create (Width, Height, PLPixelFormat::X8R8G8B8);
  m_pBmp->Create (Width, Height, PLPixelFormat::X8R8G8B8);
...
void CDibtestDlg::setAlphaChannel (CGrItemArray * pDIBArray)
{
  ...
  AlphaDecoder.MakeBmpFromResource (
					...
					IDR_LOGOALPH, pAlphaBmp, PLPixelFormat::DONTCARE);
...
|
|      $Log: maindlg.cpp,v $
|      Revision 1.13  2004/09/11 12:41:38  uzadow
|      removed plstdpch.h
|
|      Revision 1.12  2004/06/19 17:04:22  uzadow
|      Removed Lock(), Unlock(), PLDDrawBmp
|
|      Revision 1.11  2003/11/21 23:37:04  uzadow
|      no message
|
