...
/--------------------------------------------------------------------
|
|      $Id: plpictdec.h,v 1.10 2004/06/19 16:49:07 uzadow Exp $
|
...
private:
  ...
  void DecodeOp9a(PLBmpBase * pBmp, PLDataSource * pDataSrc);
  ...
  void DecodeJPEG(PLBmpBase * pBmp, PLDataSource * pDataSrc);
  ...
  void DecodeBitmap( PLBmpBase * pBmp, PLDataSource * pDataSrc);

  // Decode version 2 pixmap.
  void doPixmap( PLDataSource * pDataSrc);

  void DecodePixmap( PLBmpBase * pBmp, PLDataSource * pDataSrc);
