...
void PLBmpEncoder::DoEncode(PLBmpBase *pBmp, PLDataSink *pSink) {
  ...
  if(BPP <= 8) {
    ...
    for (int y = FileBMI.biHeight-1; y >= 0; y--) {
      ...
      for (int x = 0; x < FileBMI.biWidth; x++) {
