...
private:
  ...
  void decode1bpp(PLDataSource *pDataSrc, PLBmpBase *pBmp);

  // Decodes an uncompressed 16-color-bitmap.
  void decode4bpp(PLDataSource *pDataSrc, PLBmpBase *pBmp);

  // Decodes an uncompressed 256-color-bitmap.
  void decode8bpp(PLDataSource *pDataSrc, PLBmpBase *pBmp);

  // Decodes a compressed 16-color-bitmap.
  void decodeRLE4(PLDataSource *pDataSrc, PLBmpBase *pBmp);

  // Decodes a compressed 256-color-bitmap.
  void decodeRLE8(PLDataSource *pDataSrc, PLBmpBase *pBmp);

  void decodeHiColor(PLDataSource *pDataSrc, PLBmpBase *pBmp, WINBITMAPINFOHEADER *pBMI);

  // Decodes true-color bitmap
  void decodeTrueColor(PLDataSource *pDataSrc, PLBmpBase *pBmp, int SrcBPP);
  void decode15bppLine(PLDataSource *pDataSrc, PLBmpBase *pBmp, PLBYTE *pDest);
  void decode16bppLine(PLDataSource *pDataSrc, PLBmpBase *pBmp, PLBYTE *pDest);
  void decode24bppLine(PLDataSource *pDataSrc, PLBmpBase *pBmp, PLBYTE *pDest);
  void decode32bppLine(PLDataSource *pDataSrc, PLBmpBase *pBmp, PLBYTE *pDest);
