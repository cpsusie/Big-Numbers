...
#ifdef _WIN32
  void OpenW(const wchar_t *pszwName, PLBYTE *pData, size_t MaxDataSize);
#endif
...
inline size_t PLDataSink::GetDataSize() { // return currently used buffer size
  return m_nCurPos;
}
...
inline void PLDataSink::Skip(size_t n) {
