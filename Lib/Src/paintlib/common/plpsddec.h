...
private:
  ...
  PLBmpInfo *createBmpInfo(int Mode, int Height, int Width, int Channels, const PLPoint& Resolution);
  ...
  void readImageData(PLDataSource *pDataSrc, PLBmpBase *pBmp, int Mode, int Height, int Width, int Channels);

  void traceCompressionMethod(PLWORD CompressionMethod);

  void readUncompressedImage(PLDataSource *pDataSrc, PLBmpBase *pBmp, int Mode, int Height, int Width, int Channels );
