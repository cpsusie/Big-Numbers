...
public:
  ...
  virtual void MakeFileFromBmp(const char *, PLBmpBase*);

#ifdef _WIN32
  virtual void MakeFileFromBmpW(const wchar_t *,PLBmpBase*);
#endif
...
protected:
  ...
  //!
  virtual void DoEncode(PLBmpBase* pBmp, PLDataSink* pDataSrc) = 0;
};
#endif
/*
/--------------------------------------------------------------------
