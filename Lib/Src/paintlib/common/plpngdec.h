...
private:
  static void PLPNGDecoder::user_error_fn( png_structp png_ptr, png_const_charp error_msg);
  static void PLPNGDecoder::user_warning_fn( png_structp png_ptr, png_const_charp warning_msg);
