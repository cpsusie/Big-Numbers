...
private:
  ...
  void readImage(TGAHEADER *pTgaHead, PLBmpBase * pBmp, PLDataSource * pDataSrc);

  // Reads image data line-by-line.
  void readData(TGAHEADER *pTgaHead, bool bCompressed, PLBmpBase * pBmp, PLDataSource * pDataSrc);
