...
private:
  ...
  void readImage (PLBmpBase * pBmp, PLDataSource * pDataSrc);
  void readData(PLBmpBase * pBmp, PLDataSource * pDataSrc);
  ...
  PLPixel32 PLPPMDecoder::readASCIIPixel32( int MaxGrayValue, PLDataSource * pDataSrc);
