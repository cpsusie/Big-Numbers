...
static png_fixed_point png_get_fixed_point(png_structp png_ptr, png_const_bytep buf) { /* PRIVATE */
   png_uint_32 uval = png_get_uint_32(buf);
...
void png_read_sig(png_structp png_ptr, png_infop info_ptr) { /* PRIVATE */
 ...
 */
png_uint_32 png_read_chunk_header(png_structp png_ptr) { /* PRIVATE */
   png_byte buf[8];
   png_uint_32 length;
...
void png_crc_read(png_structp png_ptr, png_bytep buf, png_size_t length) { /* PRIVATE */
   if(png_ptr == NULL)
     return;
 ...
 */
int png_crc_finish(png_structp png_ptr, png_uint_32 skip) { /* PRIVATE */
   png_size_t i;
 ...
 */
int png_crc_error(png_structp png_ptr) { /* PRIVATE */
   ...
   while(1) {
...
#ifdef PNG_WARNINGS_SUPPORTED
      {
         ...
         if(png_ptr->zstream.msg != 0) {
           ...
           switch(ret) {
           case Z_BUF_ERROR : msg = "Buffer error in compressed datastream"; break;
           case Z_DATA_ERROR: msg = "Data error in compressed datastream";   break;
           default          : msg = "Incomplete compressed datastream";      break;
           }
         }
 ...
 */
 void png_decompress_chunk(png_structp png_ptr, int comp_type, png_size_t chunklength, png_size_t prefix_size, png_size_t *newlength) { /* PRIVATE */
   ...
   if(prefix_size > chunklength) {
       ...
       */
         ...
         png_charp text = (png_charp)png_malloc_warn(png_ptr, prefix_size + expanded_size + 1);
...
void png_handle_IHDR(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_byte buf[13];
...
void png_handle_PLTE(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
...
void png_handle_IEND(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
...
void png_handle_gAMA(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   ...
   if(igamma <= 0) {
     png_warning(png_ptr, "Ignoring gAMA chunk with out of range gamma");
     return;
   }
...
void png_handle_sBIT(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_size_t truelen;
   png_byte buf[4];
...
void png_handle_cHRM(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_byte buf[32];
   png_fixed_point x_white, y_white, x_red, y_red, x_green, y_green, x_blue, y_blue;
...
#  endif
   ...
   png_set_cHRM_fixed(png_ptr, info_ptr, x_white, y_white, x_red, y_red, x_green, y_green, x_blue, y_blue);
}
#endif

#ifdef PNG_READ_sRGB_SUPPORTED
void png_handle_sRGB(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   int intent;
   png_byte buf[1];
   ...
   if(info_ptr != NULL && (info_ptr->valid & PNG_INFO_gAMA)) {
     if(PNG_OUT_OF_RANGE(info_ptr->gamma, 45500, 500)) {
       PNG_WARNING_PARAMETERS(p)
       png_warning_parameter_signed(p, 1, PNG_NUMBER_FORMAT_fixed, info_ptr->gamma);
       png_formatted_warning(png_ptr, p, "Ignoring incorrect gAMA value @1 when sRGB is also present");
     }
   }
...
void png_handle_iCCP(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
...
void png_handle_sPLT(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
/* Note: this does not properly handle chunks that are > 64K under DOS */
...
#ifdef PNG_READ_tRNS_SUPPORTED
void png_handle_tRNS(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
...
void png_handle_bKGD(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_size_t truelen;
   png_byte buf[6];
...
void png_handle_hIST(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   unsigned int num, i;
...
void png_handle_pHYs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_byte buf[9];
...
void png_handle_oFFs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_byte buf[9];
...
void png_handle_pCAL(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_int_32 X0, X1;
...
/* Read the sCAL chunk */
void png_handle_sCAL(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
...
void png_handle_tIME(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_byte buf[7];
   png_time mod_time;
...
/* Note: this does not properly handle chunks that are > 64K under DOS */
void png_handle_tEXt(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_textp text_ptr;
   png_charp key;
   png_charp text;
   png_uint_32 skip = 0;
...
void png_handle_zTXt(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_textp text_ptr;
   png_charp text;
   int comp_type;
   int ret;
...
/* Note: this does not correctly handle chunks that are > 64K under DOS */
void png_handle_iTXt(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_textp text_ptr;
 ...
 */
 void png_handle_unknown(png_structp png_ptr, png_infop info_ptr, png_uint_32 length) { /* PRIVATE */
   png_uint_32 skip = 0;
...
void png_check_chunk_name(png_structp png_ptr, png_uint_32 chunk_name) { /* PRIVATE */
   int i;
 ...
 */
void png_combine_row(png_structp png_ptr, png_bytep dp, int display) { /* PRIVATE */
...
#ifdef PNG_READ_INTERLACING_SUPPORTED
/* PRIVATE */
void png_do_read_interlace(png_row_infop row_info, png_bytep row, int pass, png_uint_32 transformations /* Because these may affect the byte layout */) {
...
static void png_init_filter_functions_neon(png_structp pp, unsigned int bpp) {
#ifdef __linux__
