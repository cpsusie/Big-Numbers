...
#endif
#pragma comment(lib, LIB_VERSION "GifLib.lib")
...
void                   EGifSetGifVersion(      GifFileType                *GifFile
                                              ,const bool                  gif89);
...
int                    EGifPutExtensionLeader( GifFileType                *GifFile
