...
String ParserActionArray::toString(const AbstractSymbolNameContainer &nameContainer) const {
  String result;
  for(const ParserAction pa : *this) {
...
String ParserAction::toString(const AbstractSymbolNameContainer &nameContainer) const {
