...
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 24: /* dialogDefinition -> identifier DIALOG resourceAttributeList rectangleSpec dialogSpecList BEGIN opt_dialogControlSpecList END */
...
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 25: /* extendedDialogDefinition -> identifier DIALOGEX rectangleSpec extendedDialogSpecList BEGIN opt_dialogControlSpecList END */
...
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 358: /* menuDefinition -> identifier menuType resourceAttributeList menuBody */
#line 634 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode(getPos(1), menuDefinition, getStackTop(3), getStackTop(0), NULL); }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 361: /* menuBody -> BEGIN menuSpecList END */
#line 641 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = getStackTop(1); }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 362: /* menuSpecList -> menuSpecList menuSpec */
#line 644 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = (getStackTop(1)&&getStackTop(0))
                                                                                                     ? newNode(getPos(2), COMMA, getStackTop(1), getStackTop(0), NULL)
                                                                                                     : getStackTop(1)? getStackTop(1): getStackTop(0);
                                                                                                }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 366: /* popupMenu -> POPUP string menuItemModifierList menuBody */
#line 655 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode(getPos(1), POPUP, getStackTop(2), getStackTop(0), NULL); }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 367: /* menuItem -> _MENUITEM string COMMA identifierOrNumber menuItemModifierList */
#line 658 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode(getPos(1), _MENUITEM, getStackTop(3), getStackTop(1), NULL); }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 368: /* menuItem -> _MENUITEM SEPARATOR */
#line 659 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = NULL; }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 408: /* acceleratorsDefinition -> identifier ACCELERATORS resourceAttributeList BEGIN acceleratorList END */
#line 717 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
...
#line 724 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
...
#line 751 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
...
#line 755 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode(getPos(1), COMMA, getStackTop(1), getStackTop(0), NULL); }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 429: /* stringSpec -> identifier string */
#line 759 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
...
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 469: /* number -> NUMBER */
#line 843 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode( getPos(1), NUMBER, ttoi(getText()));       }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 470: /* identifier -> IDENTIFIER */
#line 846 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
    { m_dollardollar = newNode( getPos(1), IDENTIFIER, getText());         }
#line 26 "C:\\mytools\\parsergen\\lib\\parsegencpp.par"
    break;
  case 471: /* string -> STRING */
#line 849 "C:\\mytools2015\\CheckMnemonics\\Resource.y"
