...
\****************************************************************************/
static const BYTE compressedSet[2] = { 0xfe,0x1f
...
#define act0002 (void*)0x00060005    /* shift to 6 on f                          */
#define act0003 (void*)0x00060005    /* shift to 6 on f                          */
#define act0004 (void*)0x00090004    /* shift to 9 on d                          */
#define act0005 (void*)0x000a0003    /* shift to 10 on c                         */
#define act0006 (void*)0xfffb8000    /* reduce by 5 on tokens in set[0]          */
#define act0007 (void*)0x000b0003    /* shift to 11 on c                         */
#define act0008 (void*)0x000c0004    /* shift to 12 on d                         */
#define act0009 (void*)0xffff0000    /* reduce by 1 on EOI                       */
#define act0010 (void*)0xfffe0000    /* reduce by 2 on EOI                       */
#define act0011 (void*)0xfffd0000    /* reduce by 3 on EOI                       */
#define act0012 (void*)0xfffc0000    /* reduce by 4 on EOI                       */

static const TableType act0000[] = {   2,   1,   2,   2,   3};

// Total size of uncompressed actNNNN tables:8 bytes.

static const void *action[13] = {
   act0000,act0001,act0002,act0003,act0004,act0005,act0006,act0007,act0008,act0009
  ,act0010,act0011,act0012
}; // Size of table:104 bytes.
...
static const TableType succ0002[] = {  2,   8,   4,   9,   5};
static const TableType succ0003[] = {  2,   8,   7,   9,   8};

// Total size of all succNNNN tables:20 bytes.

static const TableType *successor[13] = {
   succ0000,NULL    ,succ0002,succ0003,NULL    ,NULL    ,NULL    ,NULL    ,NULL    ,NULL
  ,NULL    ,NULL    ,NULL
}; // Size of pointertable:104 bytes.
...
* Used for debugging.                                                        *
\****************************************************************************/
static const TCHAR *symbolName[10] = {
  /*   0 */ _T("EOI"),
  /*   1 */ _T("a"),
  /*   2 */ _T("b"),
  /*   3 */ _T("c"),
  ...
  /*   8 */ _T("A"),
  /*   9 */ _T("B")
}; // Total size of strings:44 bytes, size of pointertable:80 bytes.

static const ParserCharTables Olm637Tables_s(compressedSet, compressedLasets
                                            ,action, successor, productionLength, leftSide
                                            ,rightSideTable, symbolName
                                            ,6, 10, 7, 13);

const ParserTables *Olm637Tables = &Olm637Tables_s;
// Size of Olm637Tables_s: 88 bytes. Size of Olm637Tables:8 bytes


// Total size of table data:496 bytes.
