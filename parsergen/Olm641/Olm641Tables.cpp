...
// Total size of uncompressed actNNNN tables:40(x86)/40(x64) bytes.
...
static const void *action[21] = {
  ...
  ,act0020
}; // Size of table:84(x86)/168(x64) bytes.
...
// Total size of all succNNNN tables:36(x86)/48(x64) bytes.
...
static const TableType *successor[21] = {
  ...
  ,NULL
}; // Size of pointertable:84(x86)/168(x64) bytes.
...
// Size of Olm641Tables_s: 48(x86)/88(x64) bytes. Size of Olm641Tables:4(x86)/8(x64) bytes


// Total size of table data:476(x86)/760(x64) bytes.
