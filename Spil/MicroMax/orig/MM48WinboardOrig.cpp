...
int M=136,S=128,I=8000,Q,O,K,N,j,R,J,Z;        // M=0x88                   
...
D(int k, int q, int l, int e, int E, int z, int n) {      // recursive minimax search, k=moving side, n=depth
