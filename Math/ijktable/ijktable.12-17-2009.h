...
class ISOSURFACE_TABLE_POLYHEDRON {
 ...
 public:
  ...
  ISOSURFACE_TABLE_POLYHEDRON(const ISOSURFACE_TABLE_POLYHEDRON & init);  ///< Copy constructor.
  const ISOSURFACE_TABLE_POLYHEDRON & operator =(const ISOSURFACE_TABLE_POLYHEDRON &);  ///< Assignment.
...
protected:
  ...
  void ComputeAmbiguousFacets(const int * vertex_sign, FACET_SET & facet_set, FACET_INDEX & num_ambiguous_facets) const;
...
bool is_poly_ambiguous(const ISOSURFACE_TABLE_POLYHEDRON &poly, const int *vertex_sign);

/// Return true if facet jf is ambiguous.
/// @param vertex_sign[i] = Sign of isosurface vertex i.
bool is_facet_ambiguous(const ISOSURFACE_TABLE_POLYHEDRON &poly, const FACET_INDEX jf, const int *vertex_sign);

/// Return number of vertices connected by edges to iv with same sign as iv.
/// @param vertex_sign[i] = Sign of isosurface vertex i.
int compute_num_connected(const ISOSURFACE_TABLE_POLYHEDRON &poly, const int iv, const int *vertex_sign);
...
/// @param vertex_sign[i] = Sign of isosurface vertex i.
int compute_num_connected_in_facet(const ISOSURFACE_TABLE_POLYHEDRON &poly, const FACET_INDEX jf, const int iv, const int * vertex_sign);

/// Compute ambiguous facets.
/// @param vertex_sign[i] = Sign of isosurface vertex i.
void compute_ambiguous_facets(const ISOSURFACE_TABLE_POLYHEDRON &poly, const int *vertex_sign,
