...
/*                                                                           */
/*****************************************************************************/
void report(const TriangulateIO  &io
           ,int                   markers
           ,int                   reporttriangles
           ,int                   reportneighbors
           ,int                   reportsegments
           ...
           ,int                   reportnorms)
{
  ...
  for (i = 0; i < io.numberofpoints; i++) {
    printf("Point %4d:", i);
    for (j = 0; j < 2; j++) {
      printf("  %9.6g", io.pointlist[i * 2 + j]);
    }
    if (io.numberofpointattributes > 0) {
      printf("   attributes");
    }
    for (j = 0; j < io.numberofpointattributes; j++) {
      printf("  %9.6g", io.pointattributelist[i * io.numberofpointattributes + j]);
    }
    if (markers) {
    ...
    for (i = 0; i < io.numberoftriangles; i++) {
      if (reporttriangles) {
        ...
        for (j = 0; j < io.numberoftriangleattributes; j++) {
          printf("  %9.6g", io.triangleattributelist[i * io.numberoftriangleattributes + j]);
        }
        printf("\n");
      }
      if (reportneighbors) {
...
int main()
{
  ...
  in.pointlist = MALLOC(REAL, in.numberofpoints * 2);
  in.pointlist[0] = 0.0;
  in.pointlist[1] = 0.0;
  in.pointlist[2] = 1.0;
  in.pointlist[3] = 0.0;
  ...
  in.pointlist[6] = 0.0;
  in.pointlist[7] = 10.0;
  in.pointattributelist    = MALLOC(REAL, in.numberofpoints * in.numberofpointattributes);
  in.pointattributelist[0] = 0.0;
  in.pointattributelist[1] = 1.0;
  in.pointattributelist[2] = 11.0;
  in.pointattributelist[3] = 10.0;
  in.pointmarkerlist       = MALLOC(int, in.numberofpoints);
  ...
  in.regionlist    = MALLOC(REAL, in.numberofregions * 4);
  in.regionlist[0] = 0.5;
  in.regionlist[1] = 5.0;
  ...
  mid.trianglearealist    = MALLOC(REAL, mid.numberoftriangles);
