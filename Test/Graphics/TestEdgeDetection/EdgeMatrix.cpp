...
const Direction EdgeMatrix::leftTurn[5]    = { E, N, W, S, NODIR };
const Direction EdgeMatrix::rightTurn[5]   = { W, S, E, N, NODIR };
const Direction EdgeMatrix::oppositeDir[5] = { N, W, S, E, NODIR };
...
Direction EdgeMatrix::findStepDirectionFirst(Direction dir) const {
  switch(dir) {
  case S:
    if((m_allAttr & (A10|A01)) == A10) return W;
    if((m_allAttr & (A21|A10)) == A21) return S;
