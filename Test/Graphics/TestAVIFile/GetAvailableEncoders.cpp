    ...
    )
{
    ...
    if (SUCCEEDED(hr))
    {
        hr = CoCreateInstance(ppCLSIDs[0], nullptr,
...
{
    HRESULT hr = S_OK;
    IMFActivate** pActivateArray = nullptr;
    ...
    do
    {
        ...
        hr = MFTEnumEx(
            ...
            flags,                              // search flags
            nullptr,                               // match all input types for an encoder
