...
typedef BigReal   (* BigRealFunction1Pool )(const BigReal  &x, const BigReal  &f, DigitPool *    );
typedef BigReal   (*rBigRealFunction1     )(const BigReal  &x, size_t digits                     );
typedef BigReal   (*rBigRealFunction1Pool )(const BigReal  &x, size_t digits    , DigitPool *    );
