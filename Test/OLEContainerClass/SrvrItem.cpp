...
IMPLEMENT_DYNAMIC(COLEContainerClassSrvrItem, COleServerItem)
...
BOOL COLEContainerClassSrvrItem::OnDraw(CDC *pDC, CSize& rSize)
{
...
void COLEContainerClassSrvrItem::Dump(CDumpContext &dc) const
{
